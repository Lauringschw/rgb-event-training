...
def merge(window_ms: int):
    ...
    print("=" * 60)
    print(f"MERGE VOXEL: {window_ms}ms batches -> final dataset")
    print("=" * 60)
    ...
    out_data   = SLIDING_DIR_MERGED / "voxel_data.npy"
    out_labels = SLIDING_DIR_MERGED / "voxel_labels.npy"
    out_recids = SLIDING_DIR_MERGED / "voxel_recording_ids.npy"
    ...
    print("=" * 60)
    print(f"Output: {SLIDING_DIR_MERGED}")
    print(f"Next step: python3 train_voxel.py --window_ms {window_ms}")
